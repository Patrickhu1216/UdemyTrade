# Lecture 0：量化輪動交易系統研發筆記

## 導論與核心架構

本課程利用 Python 建立一個**資產配對輪動交易策略（Asset Pair Rotation Strategy）**。
...
# Lecture 1：量化金融核心指標解析：累積報酬率 vs 年化滾動報酬率
